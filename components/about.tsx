...
const About = () => {
  ...
  return (
    <motion.section id='about' ref={ref} initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.175 }}
      className='max-w-[60rem] text-center mt-36 leading-8 mb-20 sm:mb-40 scroll-mt-28'>
          ...
          <div className='text-lg mt-12 xl:mt-3'>
            <div className='flex justify-start flex-col'>
              ...
              <Fade direction='up' delay={400} cascade damping={1e-1} triggerOnce={true}>
                ...
                <p className='mt-2 leading-relaxed text-sm text-gray-700 dark:text-white/70 '>Explore a wide range of subjects, stay updated with the latest content, and grow your knowledge tree with us. Let SYLLABUSTREE guide you to academic success.</p>
              </Fade>
            </div>
          </div>
        </div>
